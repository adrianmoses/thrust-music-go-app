...
class HookNewView extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            activeTrigger: {
    ...
    saveHook(e) {
        ...
        this.props.saveNewHookWithData(this.props.token, newData).then(
            () => {
